...
public class CustomadeProgressBar extends ProgressBar{

	private String text_progress;  
    private Paint mPaint;//画笔  
  
    public CustomadeProgressBar(Context context) {  
        super(context);  
        initPaint();  
    }  
    public CustomadeProgressBar(Context context, AttributeSet attrs) {  
        super(context, attrs);  
        initPaint();  
    }  
    public CustomadeProgressBar(Context context, AttributeSet attrs, int defStyle) {  
